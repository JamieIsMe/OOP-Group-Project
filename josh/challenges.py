...
class Challenges:
    ...
    def book_roulette(self):
        ...
        print("========INSTRUCTIONS===========")
        print("There are 3 books, and the book you will recieve is random!, solve the given book puzzle to \nadvance to the final challenge!"
              "\nand earn coins!")
    ...
    def solve_riddle(self):
        ...
        while True:
            ...
            if player_answer.lower() == "egg" or player_answer.lower() == '1':
                print("Congratulations! You've solved the puzzle!, here is 3 coins")
                break
            else:
                print("Unfortunately, that's not the correct answer. Keep trying!")

    def solve_puzzle(self):
        # Implement logic for the word manipulation challenge
        print("Here is your perplexing puzzle: \n")
        time.sleep(1)
        puzzle_description = "Reorder the letters of the word 'NAANAB' to create the name of a certain yellow fruit."
        ...
        while True:
            try:
                ...
                if user_solution == correct_solution:
                    print(
                        "Congratulations! You've solved the puzzle. Here are 3 more coins.")
                    break
                else:
                    print("Sorry, that's not the correct solution. Keep trying!")
            except Exception as e:
                print(
                    f"An error occurred: {e}. Please enter a valid response.")
    ...
    def history_trivia(self):
        ...
        while True:
            ...
            if player_answer.lower() == "england" or player_answer.lower() == '3':
                print(
                    "Congratulations! You've solved the trivia question! Here are 3 more coins.")
                break
            else:
                print("Unfortunately, that's not the correct answer. Keep trying!")
